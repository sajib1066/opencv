...
def average_slope_intercept(image, lines):
    ...
    left_line = None if not left_fit else make_coordinate(image, left_fit_average)
    right_line = None if not right_fit else make_coordinate(image, right_fit_average)
